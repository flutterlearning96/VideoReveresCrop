...
extension VideoMainViewController:UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate
{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        guard let mediaType = info[UIImagePickerController.InfoKey.mediaType] as? String,
            ...
            let urlValue = info[UIImagePickerController.InfoKey.mediaURL] as? URL
            else { return }
    ...
    func saveToCameraRoll(URL: URL) {
        PHPhotoLibrary.shared().performChanges({
            ...
            if saved {
                let alertController = UIAlertController(title: "Info", message: "Croped process is completed. Video is successfully saved", preferredStyle: .alert)
